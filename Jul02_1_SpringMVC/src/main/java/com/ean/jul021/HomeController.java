...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		...
		//		Spring 4.x.x.에서부터 제공
		//  *5. @ResponseBody :
		//		자바 객체를 HTTP 요청의 body내용으로 매핑을 하는 역할
		...
		//			: 언마샬링 (Unmashalling)
		//		XmlRootElement : Javabean 객체의 Class명 위에 명시 0
		//		XmlElement : Javabean 객체의 setter에 명시 0
		//	*8. @RequestMapping
		...
		//			W3C(표준 개발 기구, World Wide Web Consorium)에서
