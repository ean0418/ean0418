...
public class AMain1 {
	public static void main(String[] args) {
		int[] eng = new int[3]; // 배열의 지정된 범위가 아니면 에러!
		eng[0] = 100;
		eng[1] = 70;
		eng[2] = 50;
...
//		b[1] = 20; // 배열의 지정된 범위에 들어가지 않아서 ERROR!
//		System.out.println(b[2]);
		...
		// 단점 : 주석없이도 해석할 수 있는지 ?
		//students.get.getKoreScore() 가 더 보기 좋음
