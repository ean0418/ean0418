...
<body>
	<table id="signupTbl">
		<form action="member.update" method="post" enctype="multipart/form-data">
				...
				<input value="${sessionScope.loginMember.ms_id }" name="ms_id" placeholder="ID" autofocus="autofocus" 
			...
			<tr>
				...
				<td align="center">
					<div class="fileBox">
						<input class="uploadName" value="${sessionScope.loginMember.ms_photo }" placeholder="Profile Pic">
