...
import com.ean.jul022.book.Book;
import com.ean.jul022.dog.Dog;
...
//		System.out.println(d.getAge()); 
		...
		// 책 객체를 만들어서 이름-가격 출력
		Book b = aac.getBean("b", Book.class); // xml 객체 불러오기
		System.out.println(b.getName());
		System.out.println(b.getPrice());
		System.out.println("---------");
		
		Book b2 = aac.getBean("b2", Book.class); // xml 객체 불러오기
		System.out.println(b2.getName());
		System.out.println(b2.getPrice());
		System.out.println("---------");
		
		Book b3 = aac.getBean("b3", Book.class); // xml 객체 불러오기
