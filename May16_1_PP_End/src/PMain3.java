...
// nextLine()은 Enter를 치키 전까지 쓴 문자열 모두 반환함
...
public class PMain3 {
	public static void main(String[] args) {
		...
		System.out.println("첫번째 도전자의 이름을 입력하세요 >");
		String user1 = k.next();
		...
		System.out.println("두번째 도전자의 이름을 입력하세요 >");
		String user2 = k.next();
		...
		if (Math.abs(result1)-10 < Math.abs(result2)-10) {
			System.out.printf("%s님이 %.3f초 차이로 승리하였습니다!", user1, Math.abs(result1-result2));
